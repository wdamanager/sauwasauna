    ...
    selection: {
      ...
      requirements: [
        ...
        },
        {
          ...
          description: 'Cada ubicación se evalúa individualmente para garantizar que cumpla con todos los requisitos logísticos y operativos acordes a los estándares de calidad y comodidad que queremos disfruten nuestros clientes.',
        },
        {
    ...
    selection: {
      ...
      requirements: [
        ...
        },
        {
          ...
          description: 'Cada ubicació s\'avalua individualment per garantir que compleixi amb tots els requisits logístics i operatius d\'acord amb els estàndards de qualitat i comoditat que volem que gaudeixin els nostres clients.',
        },
        {
          icon: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="currentColor" stroke-width="2"/><path d="M9 12L11 14L15 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    ...
    selection: {
      ...
      requirements: [
        ...
        },
        {
          ...
          description: 'Each location is individually evaluated to ensure it meets all logistical and operational requirements according to the quality and comfort standards we want our customers to enjoy.',
        },
        {
          icon: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="currentColor" stroke-width="2"/><path d="M9 12L11 14L15 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    ...
    selection: {
      ...
      requirements: [
        ...
        },
        {
          ...
          description: 'Chaque emplacement est évalué individuellement pour garantir qu\'il répond à toutes les exigences logistiques et opérationnelles conformément aux normes de qualité et de confort que nous voulons que nos clients apprécient.',
        },
        {
          icon: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="currentColor" stroke-width="2"/><path d="M9 12L11 14L15 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
